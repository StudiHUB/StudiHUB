...
<!-- content location-->
  ...
  <div class="container-fluid body" id="body">
    ...
    <div class="wrapper">
      ...
      $display="SELECT * FROM materials WHERE university='$institution'or faculty='$faculty' or level='$level'";
      $displaymaterials=mysqli_query($conn,$display);
      if (mysqli_num_rows($displaymaterials) > 0){
        # code...

      while ($row=mysqli_fetch_assoc($displaymaterials)) {
        $materialid=$row['id'];
    ...
    echo "<a href=\"view-material/index.php?id=$materialid\">";
      ...
      echo "</a>";
          ...
          echo "<div class=\"card\">";
          echo "<span class=\"university\" style=\"font-size:40px\">Please search for your materials</span>";
          echo "<span class=\"course-code\" style=\"font-size:40px\">No personalised materials yet</span>";
        echo "</div>";
    }
    }
}
...
<?php }else {
  $_SESSION['accessdenied']="You have to be signed in first";
